...
public final class BackWeaponLayer extends RenderLayer<AvatarRenderState, PlayerModel> {
    ...
    private static StowedTransform transformFor(ItemStack stack, boolean offHand) {
        ...
        return switch (family) {
            ...
            // The staff texture is already diagonal. A 120-degree roll compensates
            // for that baked-in angle and leaves the shaft about 27 degrees above
            // the ground when viewed from behind.
            case STAFF -> new StowedTransform(StowedAnchor.BODY, -0.18F, 0.27F, 0.14F, 0.0F, 180.0F, 120.0F, 1.35F);
